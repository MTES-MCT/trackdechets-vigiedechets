    ...
    return pl.LazyFrame(
        {
            ...
            "REG": ["11", "93", "84", "75"],
            "LIBELLE_reg": ["Île-de-France", "Provence-Alpes-Côte d'Azur", "Auvergne-Rhône-Alpes", "Nouvelle-Aquitaine"],
        }
    )
...
def test_check_data_empty_with_no_data(
    departements_regions_df, regions_geodata, data_date_interval
):
...
def test_build_returns_empty_dict_when_data_empty(
    departements_regions_df, regions_geodata, data_date_interval
):
