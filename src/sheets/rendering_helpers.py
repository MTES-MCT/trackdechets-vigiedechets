...
def render_pdf_sheet_fn(computed_pk: str):
    ...
    ctx = {
        ...
        "bsdd_non_dangerous_waste_origin_graph": sheet.bsdd_non_dangerous_waste_origin_graph,
        "bsda_waste_origin_graph": sheet.bsda_waste_origin_graph,
        "bsdasri_waste_origin_graph": sheet.bsdasri_waste_origin_graph,
        "bsff_waste_origin_graph": sheet.bsff_waste_origin_graph,
        "bsvhu_waste_origin_graph": sheet.bsvhu_waste_origin_graph,
