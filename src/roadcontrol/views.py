...
from .forms import BsdSearchForm, RoadControlSearchForm, BsdAvancedSearchForm
...
class BsdSearch(FullyLoggedMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if mode == "advanced":
            ...
            context["initial_form_template"] = "roadcontrol/partials/_advanced_search_form.html"
        else:
            context["form"] = BsdSearchForm(initial={"siret": siret, "selected_company_json": selected_company_json})
            context["initial_form_template"] = "roadcontrol/partials/_simple_search_form.html"
...
class BsdSimpleSearch(FullyLoggedMixin, TemplateView):
    ...
    """
    template_name = "roadcontrol/partials/_simple_search_form.html"
    allowed_user_categories = PERMS_BSD_SEARCH
...
class BsdAdvancedSearch(FullyLoggedMixin, TemplateView):
    ...
    """
    template_name = "roadcontrol/partials/_advanced_search_form.html"
    allowed_user_categories = PERMS_BSD_SEARCH
...
class CompanySearchView(FullyLoggedMixin, TemplateView):
    ...
    """
    template_name = "roadcontrol/partials/_company_search_results.html"
    allowed_user_categories = PERMS_BSD_SEARCH
...
class BsdSearchResult(FullyLoggedMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        resp = query_td_search_bsds(**search_params) # autre query avec juste **search_params une fois que l'API est prête
