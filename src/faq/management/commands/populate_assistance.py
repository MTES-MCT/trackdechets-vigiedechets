...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            faq_root = FaqPage.objects.create(
                title="FAQ Générale",
                position=1
            )
            ...
            faq_child_2 = FaqPage.objects.create(
                title="Où trouver mes bordereaux ?",
                parent=faq_root,
                position=2
            )
            ...
            SuggestedPage.objects.create(
                parent_page=faq_child_1,
                linked_page=faq_child_2,
                order=1
            )
