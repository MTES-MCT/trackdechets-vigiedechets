...
def render_pdf_sheet_fn(computed_pk: str):
    ...
    ctx = {
        ...
        "dangerous_waste_origin_graph": sheet.dangerous_waste_origin_graph,
        "non_dangerous_waste_origin_graph": sheet.non_dangerous_waste_origin_graph,
        "amiante_waste_origin_graph": sheet.amiante_waste_origin_graph,
