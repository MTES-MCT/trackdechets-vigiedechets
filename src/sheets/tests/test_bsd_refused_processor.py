...
def test_bsd_refused_processor(
    sample_data_bsdd, sample_data_bsda, sample_data_bsdasri, sample_data_bsff, sample_waste_codes, data_date_interval
):
    ...
    expected_results = {
        "readable_id": ["bsdd-4", "bsda-3", "bsdasri-3"],
        ...
        "refusal_reason": ["Refusal reason 2", "Refusal reason 1", "Refusal reason 2"],
        "description": [
            None,
