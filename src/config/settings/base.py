...
PARQUET_BUCKET_NAME = env("PARQUET_BUCKET_NAME")
...
METABASE_SSH_HOST = env("METABASE_SSH_HOST")
METABASE_SSH_PORT = env("METABASE_SSH_PORT")
METABASE_SSH_USERNAME = env("METABASE_SSH_USERNAME")
METABASE_SSH_KEY_PASSPHRASE = env("METABASE_SSH_KEY_PASSPHRASE")
METABASE_PORT = env("METABASE_PORT")
